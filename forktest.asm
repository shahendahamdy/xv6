  ...
  58:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
  5d:	68 d8 06 00 00       	push   $0x6d8
  62:	e8 69 01 00 00       	call   1d0 <strlen>
  67:	83 c4 0c             	add    $0xc,%esp
  6a:	50                   	push   %eax
  6b:	68 d8 06 00 00       	push   $0x6d8
  70:	6a 01                	push   $0x1
  ...
  bb:	68 0a 07 00 00       	push   $0x70a
  c0:	e8 0b 01 00 00       	call   1d0 <strlen>
  c5:	83 c4 0c             	add    $0xc,%esp
  c8:	50                   	push   %eax
  c9:	68 0a 07 00 00       	push   $0x70a
  ce:	6a 01                	push   $0x1
  ...
  e2:	68 e3 06 00 00       	push   $0x6e3
  e7:	e8 e4 00 00 00       	call   1d0 <strlen>
  ec:	83 c4 0c             	add    $0xc,%esp
  ef:	50                   	push   %eax
  f0:	68 e3 06 00 00       	push   $0x6e3
  f5:	6a 01                	push   $0x1
 ...
 104:	68 f7 06 00 00       	push   $0x6f7
 109:	e8 c2 00 00 00       	call   1d0 <strlen>
 10e:	83 c4 0c             	add    $0xc,%esp
 111:	50                   	push   %eax
 112:	68 f7 06 00 00       	push   $0x6f7
 117:	6a 01                	push   $0x1
 ...
 126:	68 18 07 00 00       	push   $0x718
 12b:	e8 a0 00 00 00       	call   1d0 <strlen>
 130:	83 c4 0c             	add    $0xc,%esp
 133:	50                   	push   %eax
 134:	68 18 07 00 00       	push   $0x718
 139:	6a 01                	push   $0x1
...
int thread_join()
{
 ...
 3bd:	50                   	push   %eax
 3be:	e8 0a 03 00 00       	call   6cd <join>
...
free(void *ap)
{
 ...
 435:	a1 50 0a 00 00       	mov    0xa50,%eax
{
 ...
 456:	73 10                	jae    468 <free+0x38>
{
 ...
 481:	5b                   	pop    %ebx
  freep = p;
 482:	a3 50 0a 00 00       	mov    %eax,0xa50
}
 487:	5e                   	pop    %esi
 488:	5f                   	pop    %edi
 489:	5d                   	pop    %ebp
 ...
 4a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 4aa:	a3 50 0a 00 00       	mov    %eax,0xa50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 4cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 4d0:	8b 3d 50 0a 00 00    	mov    0xa50,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 519:	8b 3d 50 0a 00 00    	mov    0xa50,%edi
 ...
 52b:	e8 55 01 00 00       	call   685 <sbrk>
  if(p == (char*)-1)
 ...
 542:	e8 e9 fe ff ff       	call   430 <free>
  return freep;
 547:	a1 50 0a 00 00       	mov    0xa50,%eax
 ...
 574:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 577:	a3 50 0a 00 00       	mov    %eax,0xa50
}
 ...
 58e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 590:	c7 05 50 0a 00 00 54 	movl   $0xa54,0xa50
 597:	0a 00 00 
    base.s.size = 0;
 59a:	bf 54 0a 00 00       	mov    $0xa54,%edi
    base.s.ptr = freep = prevp = &base;
 59f:	c7 05 54 0a 00 00 54 	movl   $0xa54,0xa54
 5a6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 5a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 5ab:	c7 05 58 0a 00 00 00 	movl   $0x0,0xa58
 5b2:	00 00 00 
    if(p->s.size >= nunits){
...
return clone(start_routine,arg1,arg2,stack);
 ...
 5ee:	e8 d2 00 00 00       	call   6c5 <clone>
}
 5f3:	c9                   	leave  
 5f4:	c3                   	ret    
