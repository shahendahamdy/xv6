...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    1035:	e8 5b 05 00 00       	call   1595 <mkdir>
  ...
  exit();
    104b:	e8 dd 04 00 00       	call   152d <exit>
      printf(2, "mkdir: %s failed to create\n", argv[i]);
    1050:	50                   	push   %eax
    1051:	ff 33                	pushl  (%ebx)
    1053:	68 9f 18 00 00       	push   $0x189f
    1058:	6a 02                	push   $0x2
    105a:	e8 61 06 00 00       	call   16c0 <printf>
      break;
    ...
    1064:	52                   	push   %edx
    1065:	52                   	push   %edx
    1066:	68 88 18 00 00       	push   $0x1888
    106b:	6a 02                	push   $0x2
    106d:	e8 4e 06 00 00       	call   16c0 <printf>
    exit();
    1072:	e8 b6 04 00 00       	call   152d <exit>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1365:	a1 1c 1c 00 00       	mov    0x1c1c,%eax
{
    ...
    1386:	73 10                	jae    1398 <free+0x38>
{
  ...
  freep = p;
    ...
    13b1:	5b                   	pop    %ebx
  freep = p;
    13b2:	a3 1c 1c 00 00       	mov    %eax,0x1c1c
}
    13b7:	5e                   	pop    %esi
    13b8:	5f                   	pop    %edi
    13b9:	5d                   	pop    %ebp
  ...
  freep = p;
    13da:	a3 1c 1c 00 00       	mov    %eax,0x1c1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1400:	8b 3d 1c 1c 00 00    	mov    0x1c1c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1449:	8b 3d 1c 1c 00 00    	mov    0x1c1c,%edi
  ...
  return freep;
    1477:	a1 1c 1c 00 00       	mov    0x1c1c,%eax
    ...
    14a4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    14a7:	a3 1c 1c 00 00       	mov    %eax,0x1c1c
}
    ...
    base.s.ptr = freep = prevp = &base;
    14c0:	c7 05 1c 1c 00 00 20 	movl   $0x1c20,0x1c1c
    14c7:	1c 00 00 
    base.s.size = 0;
    14ca:	bf 20 1c 00 00       	mov    $0x1c20,%edi
    base.s.ptr = freep = prevp = &base;
    14cf:	c7 05 20 1c 00 00 20 	movl   $0x1c20,0x1c20
    14d6:	1c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    14d9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    14db:	c7 05 24 1c 00 00 00 	movl   $0x0,0x1c24
    14e2:	00 00 00 
    if(p->s.size >= nunits){
    ...
    161c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    1649:	0f b6 92 c4 18 00 00 	movzbl 0x18c4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1844:	eb 1a                	jmp    1860 <printf+0x1a0>
          s = "(null)";
    1846:	bb bb 18 00 00       	mov    $0x18bb,%ebx
        while(*s != 0){
