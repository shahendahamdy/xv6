...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    1035:	e8 43 05 00 00       	call   157d <unlink>
  ...
  exit();
    ...
    1053:	68 9c 18 00 00       	push   $0x189c
    1058:	6a 02                	push   $0x2
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1365:	a1 14 1c 00 00       	mov    0x1c14,%eax
{
    ...
    1386:	73 10                	jae    1398 <free+0x38>
{
  ...
  freep = p;
    ...
    13b1:	5b                   	pop    %ebx
  freep = p;
    13b2:	a3 14 1c 00 00       	mov    %eax,0x1c14
}
    13b7:	5e                   	pop    %esi
    13b8:	5f                   	pop    %edi
    13b9:	5d                   	pop    %ebp
  ...
  freep = p;
    13da:	a3 14 1c 00 00       	mov    %eax,0x1c14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1400:	8b 3d 14 1c 00 00    	mov    0x1c14,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1449:	8b 3d 14 1c 00 00    	mov    0x1c14,%edi
  ...
  return freep;
    1477:	a1 14 1c 00 00       	mov    0x1c14,%eax
    ...
    14a4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    14a7:	a3 14 1c 00 00       	mov    %eax,0x1c14
}
    ...
    base.s.ptr = freep = prevp = &base;
    14c0:	c7 05 14 1c 00 00 18 	movl   $0x1c18,0x1c14
    14c7:	1c 00 00 
    base.s.size = 0;
    14ca:	bf 18 1c 00 00       	mov    $0x1c18,%edi
    base.s.ptr = freep = prevp = &base;
    14cf:	c7 05 18 1c 00 00 18 	movl   $0x1c18,0x1c18
    14d6:	1c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    161c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    1649:	0f b6 92 bc 18 00 00 	movzbl 0x18bc(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1844:	eb 1a                	jmp    1860 <printf+0x1a0>
          s = "(null)";
    1846:	bb b5 18 00 00       	mov    $0x18b5,%ebx
        while(*s != 0){
