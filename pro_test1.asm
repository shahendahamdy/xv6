...
_pro_test1:     file format elf32-i386
...
int main(int argc, char *argv[]){
    ...
    1016:	6a 00                	push   $0x0
    1018:	e8 08 06 00 00       	call   1625 <sbrk>
      sbrk(PGSIZE);
    101d:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
      char *start = sbrk(0);
    1024:	89 c3                	mov    %eax,%ebx
      sbrk(PGSIZE);
    1026:	e8 fa 05 00 00       	call   1625 <sbrk>
      *start = 100;
    102b:	c6 03 64             	movb   $0x64,(%ebx)
      printf(1, "make the page read only\n");
    102e:	59                   	pop    %ecx
    102f:	58                   	pop    %eax
    1030:	68 f8 18 00 00       	push   $0x18f8
    1035:	6a 01                	push   $0x1
    1037:	e8 f4 06 00 00       	call   1730 <printf>
      mprotect(start, 1);
    103c:	58                   	pop    %eax
    103d:	5a                   	pop    %edx
    103e:	6a 01                	push   $0x1
    1040:	53                   	push   %ebx
    1041:	e8 0f 06 00 00       	call   1655 <mprotect>
      printf(1, "start = %d\n", *start);
    1046:	0f be 03             	movsbl (%ebx),%eax
    1049:	83 c4 0c             	add    $0xc,%esp
    104c:	50                   	push   %eax
    104d:	68 11 19 00 00       	push   $0x1911
    1052:	6a 01                	push   $0x1
    1054:	e8 d7 06 00 00       	call   1730 <printf>
      int pid = fork();
    1059:	e8 37 05 00 00       	call   1595 <fork>
      if (pid == 0){
    105e:	83 c4 10             	add    $0x10,%esp
    1061:	85 c0                	test   %eax,%eax
    1063:	74 3e                	je     10a3 <main+0xa3>
    ...
    1065:	7e 37                	jle    109e <main+0x9e>
            wait();
    1067:	e8 39 05 00 00       	call   15a5 <wait>
            printf(1, "-----parent-----\n");
    106c:	50                   	push   %eax
    106d:	50                   	push   %eax
    106e:	68 41 19 00 00       	push   $0x1941
    1073:	6a 01                	push   $0x1
    1075:	e8 b6 06 00 00       	call   1730 <printf>
            printf(1, "write on the page \n'still read only **will trap**'\n");
    107a:	5a                   	pop    %edx
    107b:	59                   	pop    %ecx
    107c:	68 88 19 00 00       	push   $0x1988
    1081:	6a 01                	push   $0x1
    1083:	e8 a8 06 00 00       	call   1730 <printf>
            *start = 5;
    1088:	c6 03 05             	movb   $0x5,(%ebx)
            printf(1, "\nTEST FAILED\n");
    108b:	5b                   	pop    %ebx
    108c:	58                   	pop    %eax
    108d:	68 53 19 00 00       	push   $0x1953
    1092:	6a 01                	push   $0x1
    1094:	e8 97 06 00 00       	call   1730 <printf>
            exit();
    1099:	e8 ff 04 00 00       	call   159d <exit>
      }
      exit();
    109e:	e8 fa 04 00 00       	call   159d <exit>
            printf(1, "-----child-----\n");
    10a3:	50                   	push   %eax
    10a4:	50                   	push   %eax
    10a5:	68 1d 19 00 00       	push   $0x191d
    10aa:	6a 01                	push   $0x1
    10ac:	e8 7f 06 00 00       	call   1730 <printf>
            printf(1, "make it read/write on the child\n");
    10b1:	58                   	pop    %eax
    10b2:	5a                   	pop    %edx
    10b3:	68 64 19 00 00       	push   $0x1964
    10b8:	6a 01                	push   $0x1
    10ba:	e8 71 06 00 00       	call   1730 <printf>
            munprotect(start, 1);
    10bf:	59                   	pop    %ecx
    10c0:	58                   	pop    %eax
    10c1:	6a 01                	push   $0x1
    10c3:	53                   	push   %ebx
    10c4:	e8 94 05 00 00       	call   165d <munprotect>
            printf(1, "write on the page\n");
    10c9:	58                   	pop    %eax
    10ca:	5a                   	pop    %edx
    10cb:	68 2e 19 00 00       	push   $0x192e
    10d0:	6a 01                	push   $0x1
    10d2:	e8 59 06 00 00       	call   1730 <printf>
            printf(1, "start = %d\n", *start);
    10d7:	83 c4 0c             	add    $0xc,%esp
            *start = 5;
    10da:	c6 03 05             	movb   $0x5,(%ebx)
            printf(1, "start = %d\n", *start);
    10dd:	6a 05                	push   $0x5
    10df:	68 11 19 00 00       	push   $0x1911
    10e4:	6a 01                	push   $0x1
    10e6:	e8 45 06 00 00       	call   1730 <printf>
            exit();
    10eb:	e8 ad 04 00 00       	call   159d <exit>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    13d5:	a1 10 1d 00 00       	mov    0x1d10,%eax
{
    ...
    13f6:	73 10                	jae    1408 <free+0x38>
{
  ...
  freep = p;
    ...
    1421:	5b                   	pop    %ebx
  freep = p;
    1422:	a3 10 1d 00 00       	mov    %eax,0x1d10
}
    1427:	5e                   	pop    %esi
    1428:	5f                   	pop    %edi
    1429:	5d                   	pop    %ebp
  ...
  freep = p;
    144a:	a3 10 1d 00 00       	mov    %eax,0x1d10
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1470:	8b 3d 10 1d 00 00    	mov    0x1d10,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    14b9:	8b 3d 10 1d 00 00    	mov    0x1d10,%edi
  ...
  return freep;
    14e7:	a1 10 1d 00 00       	mov    0x1d10,%eax
    ...
    1514:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1517:	a3 10 1d 00 00       	mov    %eax,0x1d10
}
    ...
    base.s.ptr = freep = prevp = &base;
    1530:	c7 05 10 1d 00 00 14 	movl   $0x1d14,0x1d10
    1537:	1d 00 00 
    base.s.size = 0;
    153a:	bf 14 1d 00 00       	mov    $0x1d14,%edi
    base.s.ptr = freep = prevp = &base;
    153f:	c7 05 14 1d 00 00 14 	movl   $0x1d14,0x1d14
    1546:	1d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1549:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    154b:	c7 05 18 1d 00 00 00 	movl   $0x0,0x1d18
    1552:	00 00 00 
    if(p->s.size >= nunits){
    ...
    168c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    16b9:	0f b6 92 c4 19 00 00 	movzbl 0x19c4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    18b4:	eb 1a                	jmp    18d0 <printf+0x1a0>
          s = "(null)";
    18b6:	bb bc 19 00 00       	mov    $0x19bc,%ebx
        while(*s != 0){
